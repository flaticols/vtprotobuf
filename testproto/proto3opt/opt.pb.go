...
// 	protoc        v6.32.1
// source: testproto/proto3opt/opt.proto
...
func (SimpleEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_testproto_proto3opt_opt_proto_enumTypes[0].Descriptor()
}

func (SimpleEnum) Type() protoreflect.EnumType {
	return &file_testproto_proto3opt_opt_proto_enumTypes[0]
}
...
func (SimpleEnum) EnumDescriptor() ([]byte, []int) {
	return file_testproto_proto3opt_opt_proto_rawDescGZIP(), []int{0}
}
...
func (x *OptionalFieldInProto3) Reset() {
	*x = OptionalFieldInProto3{}
	mi := &file_testproto_proto3opt_opt_proto_msgTypes[0]
...
var File_testproto_proto3opt_opt_proto protoreflect.FileDescriptor

const file_testproto_proto3opt_opt_proto_rawDesc = "" +
	"\n" +
	"\x1dtestproto/proto3opt/opt.proto\"\xbe\b\n" +
...
var (
	file_testproto_proto3opt_opt_proto_rawDescOnce sync.Once
	file_testproto_proto3opt_opt_proto_rawDescData []byte
)

func file_testproto_proto3opt_opt_proto_rawDescGZIP() []byte {
	file_testproto_proto3opt_opt_proto_rawDescOnce.Do(func() {
		file_testproto_proto3opt_opt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_testproto_proto3opt_opt_proto_rawDesc), len(file_testproto_proto3opt_opt_proto_rawDesc)))
	})
	return file_testproto_proto3opt_opt_proto_rawDescData
}

var file_testproto_proto3opt_opt_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_testproto_proto3opt_opt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_testproto_proto3opt_opt_proto_goTypes = []any{
	(SimpleEnum)(0),               // 0: SimpleEnum
	(*OptionalFieldInProto3)(nil), // 1: OptionalFieldInProto3
}
var file_testproto_proto3opt_opt_proto_depIdxs = []int32{
...
func init() { file_testproto_proto3opt_opt_proto_init() }
func file_testproto_proto3opt_opt_proto_init() {
	if File_testproto_proto3opt_opt_proto != nil {
		return
	}
	file_testproto_proto3opt_opt_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_testproto_proto3opt_opt_proto_rawDesc), len(file_testproto_proto3opt_opt_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_testproto_proto3opt_opt_proto_goTypes,
		DependencyIndexes: file_testproto_proto3opt_opt_proto_depIdxs,
		EnumInfos:         file_testproto_proto3opt_opt_proto_enumTypes,
		MessageInfos:      file_testproto_proto3opt_opt_proto_msgTypes,
	}.Build()
	File_testproto_proto3opt_opt_proto = out.File
	file_testproto_proto3opt_opt_proto_goTypes = nil
	file_testproto_proto3opt_opt_proto_depIdxs = nil
}
